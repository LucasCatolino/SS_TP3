...
public class TrajectoryFileCreator {
	...
	public TrajectoryFileCreator() throws IOException {
		...
		InputStream dynamicStream = TrajectoryFileCreator.class.getClassLoader().getResourceAsStream("dynamic.xyz");
	...
	static public void main(String[] args) throws IOException {
		...
		TrajectoryFileCreator trajectory= new TrajectoryFileCreator();
